...
const GameConsoleProducts = () => {
    ...
    const gameConsoles = products.filter(product => product.category === 'game-consoles')

    let availableProducts = gameConsoles.map(product => {
...
export default GameConsoleProducts;